...
x_bigdata=np.load(r'D:/2021 4月開始的找回程式之旅/0409論文想做的題目/bigfinal_data/x_bigdatast.npy')
y_bigdata=np.load(r'D:/2021 4月開始的找回程式之旅/0409論文想做的題目/bigfinal_data/y_bigdata.npy')
...
n_steps = n 
n_features = 21
model = keras.Sequential(name='model-7')
...
model_dir = r'D:/2021 4月開始的找回程式之旅/lab2-logs/model7/'
#os.makedirs(model_dir)

#設定回調函數：
# TensorBoard回調函數會幫忙紀錄訓練資訊，並存成TensorBoard的紀錄檔
log_dir = os.path.join(r'D:/2021 4月開始的找回程式之旅/lab2-logs', 'model7')
...
# 載入模型
model = keras.models.load_model(r'D:/2021 4月開始的找回程式之旅/lab2-logs/model7/Best-model-1.h5')
